...
public sealed class LocalizationService
{
    private readonly Dictionary<string, Dictionary<string, string>> _resources = new()
    {
        ["ru"] = new Dictionary<string, string>
        {
            ...
            ["ImportExcelLabel"] = "Загрузить из Excel",
            ["ExportExcelLabel"] = "Экспорт в Excel",
            ["ScalarLabel"] = "Число",
            ...
            ["ExcelOpenFilter"] = "Книги Excel (*.xlsx)|*.xlsx",
            ["ExcelSaveFilter"] = "Книга Excel (*.xlsx)|*.xlsx",
            ["ImportExcelCompleted"] = "Матрица загружена из Excel: {0}x{1}.",
            ["ExportExcelCompleted"] = "Результат экспортирован в Excel.",
            ["ExcelOperationError"] = "Ошибка Excel: {0}",
            ["NoResultToExport"] = "Нет результата для экспорта.",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["ResizeLabel"] = "Resize",
            ["ImportExcelLabel"] = "Load from Excel",
            ...
            ["ExcelOpenFilter"] = "Excel workbooks (*.xlsx)|*.xlsx",
            ["ExcelSaveFilter"] = "Excel workbook (*.xlsx)|*.xlsx",
            ["ImportExcelCompleted"] = "Matrix loaded from Excel: {0}x{1}.",
            ["ExportExcelCompleted"] = "Result exported to Excel.",
            ["ExcelOperationError"] = "Excel error: {0}",
            ["NoResultToExport"] = "There is no result to export.",
